    ...
    public static class Troop{
        public static class Get{
            ...
            public static String memberName(Adaptation adaptation, String groupuin, String senderUin) {
                ...
                //AwLog.Log("--------troopMemberInfo----------");
                //AwLog.Log(XposedUtil.getFiledsInfo(troopMemberInfo).toString());
                //[{name=active_point, type=long, value=0}, {name=addState, type=int, value=0}, {name=age, type=byte, value=0}, {name=alias, type=class java.lang.String, value=null}, {name=autoremark, type=class java.lang.String, value=null}, {name=commonFrdCnt, type=int, value=-2147483648}, {name=credit_level, type=long, value=0}, {name=datetime, type=long, value=0}, {name=displayedNamePinyinFirst, type=class java.lang.String, value=null}, {name=distance, type=int, value=100}, {name=distanceToSelf, type=double, value=-100.0}, {name=distanceToSelfUpdateTimeStamp, type=long, value=0}, {name=faceid, type=short, value=0}, {name=friendnick, type=class java.lang.String, value=天星草}, {name=gagTimeStamp, type=long, value=0}, {name=globalTroopLevel, type=int, value=-100}, {name=hotChatGlamourLevel, type=int, value=-100}, {name=hwIdentity, type=int, value=0}, {name=isTroopFollowed, type=boolean, value=false}, {name=join_time, type=long, value=0}, {name=last_active_time, type=long, value=0}, {name=level, type=int, value=1}, {name=mGlamourLevel, type=int, value=0}, {name=mIsShielded, type=boolean, value=false}, {name=mUniqueTitle, type=class java.lang.String, value=null}, {name=mUniqueTitleExpire, type=int, value=0}, {name=memberuin, type=class java.lang.String, value=2059858408}, {name=msgseq, type=long, value=201944}, {name=pyAll_autoremark, type=class java.lang.String, value=null}, {name=pyAll_friendnick, type=class java.lang.String, value=null}, {name=pyAll_troopnick, type=class java.lang.String, value=null}, {name=pyFirst_autoremark, type=class java.lang.String, value=null}, {name=pyFirst_friendnick, type=class java.lang.String, value=null}, {name=pyFirst_troopnick, type=class java.lang.String, value=null}, {name=qqVipInfo, type=int, value=0}, {name=realLevel, type=int, value=0}, {name=sex, type=byte, value=1}, {name=status, type=byte, value=0}, {name=superQqInfo, type=int, value=0}, {name=superVipInfo, type=int, value=0}, {name=tribeLevel, type=int, value=0}, {name=tribePoint, type=int, value=0}, {name=troopnick, type=class java.lang.String, value=}, {name=troopremark, type=class java.lang.String, value=null}, {name=troopuin, type=class java.lang.String, value=755101024}, {name=VALUE_DISTANCE_TO_SELF_EXPIRED, type=long, value=-1000}, {name=VALUE_DISTANCE_TO_SELF_UNKOWN, type=long, value=-100}, {name=VALUE_MEMBER_CLOSE_SHARE_LBS, type=long, value=-1001}]
//[{name=active_point, type=long, value=23}, {name=addState, type=int, value=0}, {name=age, type=byte, value=0}, {name=alias, type=class java.lang.String, value=}, {name=autoremark, type=class java.lang.String, value=紫薯机一号}, {name=commonFrdCnt, type=int, value=-2147483648}, {name=credit_level, type=long, value=0}, {name=datetime, type=long, value=1596543332166}, {name=displayedNamePinyinFirst, type=class java.lang.String, value=null}, {name=distance, type=int, value=100}, {name=distanceToSelf, type=double, value=-100.0}, {name=distanceToSelfUpdateTimeStamp, type=long, value=0}, {name=faceid, type=short, value=588}, {name=friendnick, type=class java.lang.String, value=紫薯机一号}, {name=gagTimeStamp, type=long, value=0}, {name=globalTroopLevel, type=int, value=-100}, {name=hotChatGlamourLevel, type=int, value=-100}, {name=hwIdentity, type=int, value=0}, {name=isTroopFollowed, type=boolean, value=false}, {name=join_time, type=long, value=1596016175}, {name=last_active_time, type=long, value=1596542209}, {name=level, type=int, value=3}, {name=mGlamourLevel, type=int, value=0}, {name=mIsShielded, type=boolean, value=false}, {name=mUniqueTitle, type=class java.lang.String, value=null}, {name=mUniqueTitleExpire, type=int, value=0}, {name=memberuin, type=class java.lang.String, value=3396747278}, {name=msgseq, type=long, value=201945}, {name=pyAll_autoremark, type=class java.lang.String, value=zishujiyihao}, {name=pyAll_friendnick, type=class java.lang.String, value=zishujiyihao}, {name=pyAll_troopnick, type=class java.lang.String, value=}, {name=pyFirst_autoremark, type=class java.lang.String, value=zsjyh}, {name=pyFirst_friendnick, type=class java.lang.String, value=zsjyh}, {name=pyFirst_troopnick, type=class java.lang.String, value=}, {name=qqVipInfo, type=int, value=0}, {name=realLevel, type=int, value=3}, {name=sex, type=byte, value=1}, {name=status, type=byte, value=20}, {name=superQqInfo, type=int, value=0}, {name=superVipInfo, type=int, value=0}, {name=tribeLevel, type=int, value=0}, {name=tribePoint, type=int, value=0}, {name=troopnick, type=class java.lang.String, value=}, {name=troopremark, type=class java.lang.String, value=null}, {name=troopuin, type=class java.lang.String, value=755101024}, {name=VALUE_DISTANCE_TO_SELF_EXPIRED, type=long, value=-1000}, {name=VALUE_DISTANCE_TO_SELF_UNKOWN, type=long, value=-100}, {name=VALUE_MEMBER_CLOSE_SHARE_LBS, type=long, value=-1001}]
// [{name=active_point, type=long, value=75}, {name=addState, type=int, value=0}, {name=age, type=byte, value=0}, {name=alias, type=class java.lang.String, value=}, {name=autoremark, type=class java.lang.String, value=}, {name=commonFrdCnt, type=int, value=-2147483648}, {name=credit_level, type=long, value=0}, {name=datetime, type=long, value=1596380054336}, {name=displayedNamePinyinFirst, type=class java.lang.String, value=null}, {name=distance, type=int, value=100}, {name=distanceToSelf, type=double, value=-100.0}, {name=distanceToSelfUpdateTimeStamp, type=long, value=0}, {name=faceid, type=short, value=0}, {name=friendnick, type=class java.lang.String, value=赵喵喵}, {name=gagTimeStamp, type=long, value=0}, {name=globalTroopLevel, type=int, value=-100}, {name=hotChatGlamourLevel, type=int, value=-100}, {name=hwIdentity, type=int, value=0}, {name=isTroopFollowed, type=boolean, value=false}, {name=join_time, type=long, value=1595084760}, {name=last_active_time, type=long, value=1596379723}, {name=level, type=int, value=4}, {name=mGlamourLevel, type=int, value=0}, {name=mIsShielded, type=boolean, value=false}, {name=mUniqueTitle, type=class java.lang.String, value=null}, {name=mUniqueTitleExpire, type=int, value=0}, {name=memberuin, type=class java.lang.String, value=484546762}, {name=msgseq, type=long, value=216948}, {name=pyAll_autoremark, type=class java.lang.String, value=}, {name=pyAll_friendnick, type=class java.lang.String, value=zhaomiaomiao}, {name=pyAll_troopnick, type=class java.lang.String, value=zhaoyiran}, {name=pyFirst_autoremark, type=class java.lang.String, value=}, {name=pyFirst_friendnick, type=class java.lang.String, value=zmm}, {name=pyFirst_troopnick, type=class java.lang.String, value=zyr}, {name=qqVipInfo, type=int, value=0}, {name=realLevel, type=int, value=3}, {name=sex, type=byte, value=1}, {name=status, type=byte, value=20}, {name=superQqInfo, type=int, value=0}, {name=superVipInfo, type=int, value=0}, {name=tribeLevel, type=int, value=0}, {name=tribePoint, type=int, value=0}, {name=troopnick, type=class java.lang.String, value=赵怡然}, {name=troopremark, type=class java.lang.String, value=null}, {name=troopuin, type=class java.lang.String, value=323956301}, {name=VALUE_DISTANCE_TO_SELF_EXPIRED, type=long, value=-1000}, {name=VALUE_DISTANCE_TO_SELF_UNKOWN, type=long, value=-100}, {name=VALUE_MEMBER_CLOSE_SHARE_LBS, type=long, value=-1001}]
